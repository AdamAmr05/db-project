                ...
                <CyberCard>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-[var(--border-subtle)] text-xs font-mono text-muted uppercase">
                            ...
                            <tbody>
                                {filteredJobs.map((job) => (
                                    <tr key={job.Job_ID} className="border-b border-[var(--border-subtle)] hover:bg-surfaceHighlight transition-colors">
                                        <td className="p-4">
