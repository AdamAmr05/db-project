...
export const ChatBubble = React.memo(({ content }) => {
...
const ChatWidget = () => {
    ...
    // Resize state (local to widget - not shared)
    ...
    return (
        <>
            ...
            >
                ...
                {/* Input */}
                <form onSubmit={onFormSubmit} className="p-3 border-t border-border bg-[var(--surface-highlight)]">
